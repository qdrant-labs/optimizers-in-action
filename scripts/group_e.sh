...
run_one opt-e1-delayed-to-indexed results/bench-e1-delayed-to-indexed.jsonl
run_one opt-e2-delayed-to-indexed-prevent-unopt results/bench-e2-delayed-to-indexed-prevent-unopt.jsonl --prevent-unoptimized
